//! Compatibility shims for MagicBlock ER and VRF integration.
//!
//! The default `anchor-shim` feature bridges anchor-lang 1.0.0 to
//! ephemeral-rollups-sdk's Anchor account surface. The `quasar-vrf` feature adds
//! a no_std Quasar-compatible MagicBlock VRF request/callback adapter.

#![cfg_attr(not(feature = "anchor-shim"), no_std)]
#![allow(
...
#[cfg(feature = "anchor-shim")]
pub use anchor_shim::*;

#[cfg(feature = "quasar-vrf")]
pub mod quasar_vrf;
