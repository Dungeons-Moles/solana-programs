...
- **Shrapnel**: retaliatory resource.
  - When struck by a weapon attack: consume 1 Shrapnel stack and deal damage to the attacker equal to **50% of the strike's ATK** (rounded down, minimum 1).
...
- `G-ST-04` — Reinforcement Plate (Gear) [STONE] {Rare} — Image: assets/icons/items/stone/reinforcement_plate.png — `+2/4/8 ARM`; every other turn: gain `1/3/6` Armor and `1/2/4` Shrapnel
...
- `G-GR-02` — Lucky Coin (Gear) [GREED] {Common} — Image: assets/icons/items/greed/lucky_coin.png — Victory: gain `2/4/8` Gold and heal `2/4/8` HP
- `G-GR-03` — Ruby Shard (Gear) [GREED] {Common} — Image: assets/icons/items/greed/ruby_shard.png — Every other turn (on first hit): heal `2/4/8` HP
- `G-GR-04` — Pyrite Shard (Gear) [GREED] {Common} — Image: assets/icons/items/greed/pyrite_shard.png — Every other turn (on first hit): gain `2/4/8` Gold
- `G-GR-05` — Amethyst Shard (Gear) [GREED] {Common} — Image: assets/icons/items/greed/amethyst_shard.png — Every other turn (on first hit): deal `1/2/4` non-weapon damage
- `G-GR-06` — Emerald Shard (Gear) [GREED] {Common} — Image: assets/icons/items/greed/emerald_shard.png — Every other turn (on first hit): gain `2/4/8` Armor
- `G-GR-07` — Gilded Ring (Gear) [GREED] {Heroic} — Image: assets/icons/items/greed/gilded_band.png — `+2/4/8 ARM`; Battle Start: gain Armor equal to `Gold/6`, rounded down, capped at `6/12/24`; if Gold ≥ 20, also gain `+1/2/4` SPD this battle
- `G-GR-08` — Royal Bracer (Gear) [GREED] {Mythic} — Image: assets/icons/items/greed/royal_bracer.png — Turn Start: convert 1 Gold → `4/8/16` Armor (max 3 times per battle); your Gold gains from all sources are increased by `50/100/200`% (round down)
...
- `G-FR-02` — Rime Cloak (Gear) [FROST] {Rare} — Image: assets/icons/items/frost/rime_cloak.png — `+3/6/12 ARM`; when struck (once/turn): apply `1/2/4` Chill to attacker
...
- `G-FR-04` — Ice Skates (Gear) [FROST] {Rare} — Image: assets/icons/items/frost/ice_skates.png — `+2/4/8 SPD, +1/2/4 DIG`
- `G-FR-05` — Frostguard Buckler (Gear) [FROST] {Heroic} — Image: assets/icons/items/frost/frostguard_buckler.png — `+6/12/24 ARM`; Battle Start: if enemy has Chill, gain `+3/6/12` Armor and apply `1/2/4` Chill
...
- `G-RU-03` — Corroded Greaves (Gear) [RUST] {Rare} — Image: assets/icons/items/rust/corroded_greaves.png — `+1/2/4 SPD`; Battle Start: apply `1/2/4` Rust. Wounded: apply additional `2/4/8` Rust
...
- `G-RU-05` — Flaking Plating (Gear) [RUST] {Rare} — Image: assets/icons/items/rust/flaking_plating.png — `+6/12/24 ARM`; when you lose 3+ Armor in a single turn: apply `2/4/8` Rust to enemy
...
- `G-BO-01` — Last Breath Sigil (Gear) [BLOOD] {Common} — Image: assets/icons/items/blood/last_breath_sigil.png — One use: first time you would die in battle, prevent it and heal `3/6/12` HP
...
- `G-BO-04` — Blood Chalice (Gear) [BLOOD] {Rare} — Image: assets/icons/items/blood/blood_chalice.png — `+2/4/8 ARM`; Victory: heal `4/8/16` HP
...
- `G-TE-04` — Hourglass Charge (Gear) [TEMPO] {Rare} — Image: assets/icons/items/tempo/hourglass_charge.png — `+2/4/8 ARM`; Turn 3: gain `+2/4/8` ATK and `+1/2/4` SPD (this battle)
...
| GREED | T-GR-01 | G-GR-01, G-GR-02, G-GR-03, G-GR-04 | 68, 16, 17, 18, 19 |
...
```
[0x0F, 0x0F, 0x0F, 0x0F, 0x0F, 0x0F, 0x0F, 0x0F, 0x55, 0x55]
```
...
| Shard Circuit            | assets/icons/itemsets/shard_circuit.png            | `G-GR-03 + G-GR-04 + G-GR-05 + G-GR-06` | Shards trigger every turn                                                                                      |
...
| Royal Extraction         | assets/icons/itemsets/royal_extraction.png         | `G-GR-01 + G-GR-08 + T-GR-02`           | Gold→Armor becomes 1→4; gain +1 Gold at the start of each battle                                               |
...
| Golden Shrapnel Exchange | assets/icons/itemsets/golden_shrapnel_exchange.png | `G-GR-08 + G-ST-06 + G-GR-07`           | When you convert Gold→Armor: gain +3 Shrapnel (once/turn)                                                      |
...
- **B-A-W2-01 Drill Sergeant** 🪖 — Weakness `FROST + TEMPO` — `34/2/6/2/3`
  - Rev Up: Turn Start +1 ATK and +1 SPD (this battle, max +4 each).
...
- **B-B-W3-01 The Frostbound Leviathan** 🐋🧊 — Weakness `RUST + STONE` — `52/3/10/2/3`
